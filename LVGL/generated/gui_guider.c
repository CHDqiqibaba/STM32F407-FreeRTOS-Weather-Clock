...
#define UI_SCREEN_LOAD_DEBOUNCE_MS 300U

static uint8_t ui_screen_load_allowed(void)
{
    ...
    if (started &&
        (int32_t)(now - last_tick) < (int32_t)UI_SCREEN_LOAD_DEBOUNCE_MS)
    {
        return 0;
    }
